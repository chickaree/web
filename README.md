...
**NOTE: If a valid URL is not returned from a List, then the content embed in the the list will be used. This is not ideal because permalinks will not available**
